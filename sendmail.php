<?php
    ...
    $tel = filter_var($_POST['contactTel'], FILTER_SANITIZE_STRING);
    ...
    if (!$error) {
        ...
        $mail->IsHTML(true);
        $mail->Body = '<b>Name:</b> '. $name .'<br/><b>Tel:</b> '. $tel .'<br/><b>E-mail:</b> '. $email .'<br/><br/>' . $message;

        $mail->Send();

        echo "<div class='alert alert-success'  role='alert'>Thanks " . $name . ".<br />Your message has been sent.</div>";
